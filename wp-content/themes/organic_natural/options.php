...
function optionsframework_options() {
	...
	$options[] = array( "name" => __("Homepage", 'organicthemes'),
		...
		$options[] = array( "name" => __("Display Homepage Middle Section?", 'organicthemes'),
							"desc" => __("Selecting this option will display the featured pages in the middle section of the homepage.", 'organicthemes'),
							"id" => "display_home_mid",
							"std" => "1",
							"type" => "checkbox");
							
		$options[] = array( "name" => __("Display Homepage Bottom Section?", 'organicthemes'),
							"desc" => __("Selecting this option will display the featured posts in the bottom section of the homepage.", 'organicthemes'),
	...
	$options[] = array( "name" => __("Layout", 'organicthemes'),
		...
		$options[] = array( "name" => __("Display Site Title?", 'organicthemes'),
							"desc" => __("Selecting this option will display the site title and description if no logo is added.", 'organicthemes'),
